...
class SM3(Optimizer):
    ...
    # MODIFIED for fp16 support by KSK
    # all bugs my fault, original here thank you Enealor!
    # https://raw.githubusercontent.com/Enealor/PyTorch-SM3/master/src/SM3/SM3.py
    ...
    def step(self, closure=None):
        ...
        for group,fp32_group in zip(self.param_groups, self.fp32_param_groups):
            ...
            for p,fp32_p in zip(group['params'], fp32_group['params']):
                ...
                fp32_p.sub_(update, alpha=group['lr'])
                p.data = fp32_p.half()
                state['step'] += 1
        return loss
